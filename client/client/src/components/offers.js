...
export default function Offers() {
    ...
    useEffect(() => {
        axios.get("http://localhost:4000/offers").then((response) => {
    ...
    return (
        <div className="box box7" >
            ...
            {offers && offers.map((offer) => (
                <p key={offer._id}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.88" width="27" height="27" fill="white">
                    ...
                    </svg> <b>{offer.percentage}%</b> off for <b>{offer.company}</b>. Use code: <b>{offer.code}</b>. Terms and conditions may apply.
                </p>
            ))}
        </div>
    );
